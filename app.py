...
def getMetadata():
    ...
    directories =['mmg-database-1.0.0', 'aha-database-sample-excluded-record-1.0.0', 'ansiaami-ec13-test-waveforms-1.0.0', 'motion-artifact-contaminated-ecg-database-1.0.0', 'examples-of-electromyograms-1.0.0', '']
    metadata = []
